...
const components = [<Home/>,<MyMagicLunchApp/>, <WeekPlanner/>, <Home/>];
...
function NavBar() {
    ...
    return (
        <AppBar position="static" sx={{background:"#5f4079"}}>
                        ...
                        >
                            {pages.map((page, index) => (
                                <MenuItem key={page} onClick={handleCloseNavMenu}>
                                    ...
                                    <Link style={{textDecoration:"none", color:"black"}} to={`/${routes[index]}`}>
                                        {page}
